...
headers2 = {"x-api-key": "thSwyFIFfd1tHQ1PgDSv38LFqXfg7rMU7BEzDAOd", "Content-Type": "application/json;charset=utf-8"}
...
body_account = {
  "accountName": "riken.kazumi@gmail.com",
  "password": "numone2019"
}
...
# API接続の実行
requests.post(url_login,params=body_account,headers=headers)
